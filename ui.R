                      ...
                      sidebarPanel(
                        tabsetPanel(
                          ...
                          tabPanel("Filter", 
                                   ...
                                   uiOutput(outputId = 'PrecedentialStatusFilter'),
                                   ...
                                   uiOutput(outputId = 'ReplacedFilter'),
                      ...
                      wellPanel(
                        fluidRow(
                          column(6,
                                 ...
                                 uiOutput('PrecedentialStatusUpdate'), 
